...
namespace OnlineSchool.Infrastructure.Migrations
{
    ...
    [Migration("20230314155224_removeAttributesByTask")]
    partial class removeAttributesByTask
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineSchool.Domain.Teacher.TeacherEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineSchool.Domain.Course.CourseEntity", b =>
                {
                    b.HasOne("OnlineSchool.Domain.Teacher.TeacherEntity", "Teacher")
                        .WithMany("Courses")
